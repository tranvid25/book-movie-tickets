...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8000/api/auth/messages", {
    ...
    useEffect(() => {
        ...
        channel.listen("App\\Events\\UserOnline", (data) => {
            setMessages((prev) => [
                ...prev,
                {
                                ...
                                {msg.file_path && (
                                    <div style={{ marginTop: 6 }}>
                                        {msg.file_path.match(/\.(jpg|jpeg|png|gif)$/i) ? (
                                            <img src={msg.file_path} alt="file" style={{ maxWidth: 180, maxHeight: 180, borderRadius: 8, marginTop: 4 }} />
                                        ) : (
                                            <a href={msg.file_path} target="_blank" rel="noopener noreferrer" style={{ color: isUser ? "#fff" : "#007bff", textDecoration: "underline" }}>
                                                File đính kèm
                                            </a>
                                        )}
                                    </div>
